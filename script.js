document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function clearFieldError(field) {
      ...
      if (describedBy.startsWith('error-')) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (!action) {
        const existingSuccess = contactForm.parentNode.querySelector('.form-success-message');
      ...
      fetch(action, {
        ...
        .catch(function () {
          const existingError = contactForm.parentNode.querySelector('.form-error-message');
          ...
          contactForm.parentNode.insertBefore(errorEl, contactForm.nextSibling);
        })
        .finally(function () {
          if (submitBtn) {
            submitBtn.disabled = false;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'a769d5ce-7b84-42ec-a343-6779a0f98ccc',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'a769d5ce-7b84-42ec-a343-6779a0f98ccc';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'a769d5ce-7b84-42ec-a343-6779a0f98ccc';
